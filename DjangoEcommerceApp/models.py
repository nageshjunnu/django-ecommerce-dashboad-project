...
class Products(models.Model):
    ...
    product_min_price=models.CharField(max_length=255)
...
class ProductReviews(models.Model):
    ...
    rating=models.FloatField(default="5", max_length=255)
...
class ProductVarientItems(models.Model):
    id=models.AutoField(primary_key=True)
    products_id=models.ForeignKey(ProductVarient, on_delete=models.CASCADE)
...
class OrderDeliveryStatus(models.Model):
    id=models.AutoField(primary_key=True)
    order_id=models.ForeignKey(CustomerUser, on_delete=models.CASCADE)
